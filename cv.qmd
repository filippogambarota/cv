...
:::{.pdf .no-print}
Download the {{< fa file-   pdf >}}  [PDF](index.pdf) version
:::
...
These course are part of the PhD program in Psychological Sciences at the University of Padova.
...
NoCite(bib)
bib_print <- PrintBibliography(bib, .opts = list(bib.style = "authoryear", sorting = "ydnt", max.names = 100)) |> 
  capture.output() |> 
  gsub(pattern = "Gambarota", replacement = "**Gambarota**", x = _)
